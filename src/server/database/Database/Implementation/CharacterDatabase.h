...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_SEL_QUEST_STAGE_FLAGS,
    CHAR_INS_QUEST_STAGE_FLAGS,
    CHAR_DEL_QUEST_STAGE_FLAGS,
	CHAR_SEL_CHEST_FLAGS,
	CHAR_INS_CHEST_FLAGS,
	CHAR_DEL_CHEST_FLAGS,
