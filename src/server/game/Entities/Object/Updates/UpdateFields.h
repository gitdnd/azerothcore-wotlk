...
enum EItemFields
{
    ...
    ITEM_FIELD_VISIBLE_GUID                   = OBJECT_END + 0x0006, // Size: 2, Type: LONG, Flags: PUBLIC but could be size 1 since its uint32
    ...
    // ITEM_FIELD_GIFTCREATOR = OBJECT_END + 0x003, // Size: 2, Type: LONG, Flags: PUBLIC
};
