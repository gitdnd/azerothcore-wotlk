    ...
    struct mana_wyrmAI : public ELKAI
    {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            case ATK_1:
            {
                ...
                case 1:
                    DelayAttack();
                    EasyCast(uint32(ELKSpells::ATTACK));
        ...
        {
            if (me->GetAvailableRunes() && EasyCastTarget(uint32(ELKSpells::SPELL_DEFLECT)))
            {
                exit = true;
            }
        }
    ...
    struct amani_berserkerAI : public ELKAI
    {
        ...
        void DoEvents()
        {
            ...
            case ATK_1:
            {
                ...
                {
                case 1:
                    EasyAttack(uint32(ELKSpells::ATTACK), ATK_1, 700);
                    break;
                case 2:
                    EasyAttack(uint32(ELKSpells::SPIN_ATTACK), ATK_1, 300);
                    break;
                case 3:
                    EasyAttack(uint32(ELKSpells::ATTACK), ATK_1, 1000);
                    break;
                case 4:
                    EasyAttack(uint32(ELKSpells::ATTACK), ATK_1, 700);
                    break;
            ...
            case ATK_2:
            {
                ...
                {
                case 1:
                    EasyAttack(uint32(ELKSpells::CRITICAL_ATTACK), ATK_2, 700);
                    break;
                case 2:
                    EasyAttack(uint32(ELKSpells::ATTACK), ATK_2, 1000);
                    break;
                case 3:
                    EasyAttack(uint32(ELKSpells::CRITICAL_ATTACK), ATK_2, 700);
                    break;
                case 4:
                    ...
                    break;
                case 5:
                    EasyCast(uint32(ELKSpells::CRITICAL_ATTACK));
                    comboing = 0;
                    break;
                }
                break;
            ...
            case ATK_3:
            {
                ...
                {
                case 1:
                    EasyAttack(uint32(ELKSpells::CRITICAL_ATTACK), ATK_3, 700);
                    break;
                case 2:
                    EasyAttack(uint32(ELKSpells::SPIN_ATTACK), ATK_3, 300);
                    break;
                case 3:
                    EasyAttack(uint32(ELKSpells::SPIN_ATTACK), ATK_3, 300);
                    break;
                case 4:
                    ...
                    break;
                case 5:
                    EasyCast(uint32(ELKSpells::SPIN_ATTACK));
                    comboing = 0;
                    break;
                }
                break;
            ...
            case ATK_4:
            {
                ...
                {
                case 1:
                    EasyAttack(uint32(ELKSpells::CRITICAL_ATTACK), ATK_4, 700);
                    break;
                case 2:
                    EasyAttack(uint32(ELKSpells::SPIN_ATTACK), ATK_4, 300);
                    break;
                case 3:
                    EasyAttack(uint32(ELKSpells::SPIN_ATTACK), ATK_4, 700);
                    break;
                case 4:
                    EasyAttack(uint32(ELKSpells::SPIN_ATTACK), ATK_4, 300);
                    break;
