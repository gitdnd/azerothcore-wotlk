...
CREATE PROCEDURE creature_mass_replace (IN creature1 INT, creature2 INT)
BEGIN
	UPDATE `creature` SET `id1` = creature1 WHERE (`guid` = creature2) AND elk < 1;
END;;
...
UPDATE creature SET id1 = "15644" WHERE (id1 = "15645" OR id1 = "16162" )AND elk < 1;

CALL creature_mass_replace(299, 69);;
CALL creature_mass_replace(1922, 525);;
...
DROP PROCEDURE  creature_mass_replace;;